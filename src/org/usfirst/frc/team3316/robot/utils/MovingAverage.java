...
public class MovingAverage
{
	 ...
	 * @param updateRate
	 *            the rate that a value is taken from func
	 * @param supplier
	...
	/**
	 * Schedules a timertask that updates the moving average in the timer object
	 * in robot Should be called only after timer was initialized
	 */
